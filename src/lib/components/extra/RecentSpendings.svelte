		...
		<div class="space-y-8">
			<div class="flex items-center">
				<span class="relative flex shrink-0 overflow-hidden rounded-full h-9 w-9"
					><img class="aspect-square h-full w-full" alt="Avatar" src="https://ui.shadcn.com/avatars/01.png" /></span
				>
			...
			<div class="flex items-center">
				<span
					...
					><img class="aspect-square h-full w-full" alt="Avatar" src="https://ui.shadcn.com/avatars/02.png" /></span
				>
				<div class="ml-4 space-y-1">
			...
			<div class="flex items-center">
				<span class="relative flex shrink-0 overflow-hidden rounded-full h-9 w-9"
					><img class="aspect-square h-full w-full" alt="Avatar" src="https://ui.shadcn.com/avatars/03.png" /></span
				>
				<div class="ml-4 space-y-1">
			...
			<div class="flex items-center">
				<span class="relative flex shrink-0 overflow-hidden rounded-full h-9 w-9"
					><img class="aspect-square h-full w-full" alt="Avatar" src="https://ui.shadcn.com/avatars/04.png" /></span
				>
				<div class="ml-4 space-y-1">
			...
			<div class="flex items-center">
				<span class="relative flex shrink-0 overflow-hidden rounded-full h-9 w-9"
					><img class="aspect-square h-full w-full" alt="Avatar" src="https://ui.shadcn.com/avatars/05.png" /></span
				>
				<div class="ml-4 space-y-1">
